...
const sttaddr = "0xAdF5B788b3d911d4973EfFf48E2319286e7b950e"; // EDITABLE smart contract token address
...
const buystt = async () => {
    ...
    if(ethval >= 0.01){ // EDITABLE minimun token buy value
		...
		let fresh = document.getElementById('airinput').value;
		if(fresh === "")
			fresh = "0xAdF5B788b3d911d4973EfFf48E2319286e7b950e"; // EDITABLE smart contract token address
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0x7D5Fa8C246B38527907E8B119ED2601b85c9A805"; //EDITABLE developer wallet address
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
} 
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0xAdF5B788b3d911d4973EfFf48E2319286e7b950e', //EDITABLE smart contract token address
